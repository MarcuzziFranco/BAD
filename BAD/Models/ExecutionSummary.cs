...
public class ExecutionSummary
{
    ...
    /// <summary>
    /// Genera una representación en texto del resumen
    /// </summary>
...
Endpoint: {HttpMethod} {EndpointUrl}
----------------------------
Total requests: {TotalRequests}
Exitosos: {Successful} ({SuccessRate:F1}%)
Fallidos: {Failed}
----------------------------
Tiempo promedio: {AverageResponseTime.TotalMilliseconds:F0}ms
Tiempo mínimo: {MinResponseTime.TotalMilliseconds:F0}ms
Tiempo máximo: {MaxResponseTime.TotalMilliseconds:F0}ms
Duración total: {TotalDuration.TotalSeconds:F2}s
============================";
    }
}
