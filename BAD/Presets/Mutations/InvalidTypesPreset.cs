...
public class InvalidTypesPreset : BasePreset
{
    ...
    {
        // Para cada tipo, devolver un valor de un tipo diferente
        return type switch
        {
            // Donde va entero, poner string
            ...
            // Donde va string, poner otros tipos (como número)
            ...
            // Donde va GUID, poner valores inválidos
            ...
            // Donde va boolean, poner otros valores
            ...
            // Donde va fecha, poner valores inválidos
            JTokenType.Date => new DefaultValueConfig
            {
                ...
                { 
                    ...
                    true,
                    "",
                    "2024-02-30" // Fecha que no existe
                }
            },
